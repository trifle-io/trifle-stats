...
require 'trifle/stats/aggregator/mean'
...
require 'trifle/stats/formatter/path_utils'
...
require 'trifle/stats/transponder/add'
require 'trifle/stats/transponder/divide'
require 'trifle/stats/transponder/max'
require 'trifle/stats/transponder/mean'
require 'trifle/stats/transponder/min'
require 'trifle/stats/transponder/multiply'
require 'trifle/stats/transponder/ratio'
require 'trifle/stats/transponder/standard_deviation'
require 'trifle/stats/transponder/subtract'
require 'trifle/stats/transponder/sum'
